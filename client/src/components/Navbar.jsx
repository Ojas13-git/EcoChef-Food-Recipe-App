...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    const res = await axios.get("https://ecochef-recipe-app.onrender.com/api/logout", {
  ...
  const checkUser = async () => {
    const res = await axios.get("https://ecochef-recipe-app.onrender.com/api/checkUser", {
      withCredentials: true,
    });
    const data = await res.data;
    if (data.success) {
